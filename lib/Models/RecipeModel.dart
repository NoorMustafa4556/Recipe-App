...
class RecipeModel {
  ...
  num? _skip;
  num? _limit;
RecipeModel copyWith({  List<Recipes>? recipes,
  num? total,
  num? skip,
  num? limit,
}) => RecipeModel(  recipes: recipes ?? _recipes,
  total: total ?? _total,
  skip: skip ?? _skip,
  limit: limit ?? _limit,
);
